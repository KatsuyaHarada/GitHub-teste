...
<!--header -->
			<header>
				<div class="wrapper">
					<h1><a href="index.html" id="logo">IG Controle de Veículos</a></h1>
				</div>
				<nav>
					<ul id="menu">
						<li class="active"><a href="index.html"><span>Menu Principal</span></a></li>
						<li><a href="Company.html"><span>Empresas</span></a></li>
